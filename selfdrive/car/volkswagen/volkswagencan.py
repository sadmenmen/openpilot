...
def create_mqb_hud_control(packer, bus, enabled, steering_pressed, hud_alert, left_lane_visible, right_lane_visible,
  ...
  if enabled:
    leftlanehud = 3 if left_lane_visible else 1
    rightlanehud = 3 if right_lane_visible else 1
  else:
    leftlanehud = 2 if left_lane_visible else 1
    rightlanehud = 2 if right_lane_visible else 1
