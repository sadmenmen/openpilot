...
class CarState(CarStateBase):
    ...
    def update(self, cp, cp_cam, cp_body):
        ...
        CAR.ACCORD, CAR.ACCORD_15, CAR.ACCORDH, CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.CRV_HYBRID, CAR.INSIGHT,
        CAR.ACURA_RDX_3G):
        ...
        ret.seatbeltUnlatched = bool(
            cp.vl["SEATBELT_STATUS"]['SEATBELT_DRIVER_LAMP'] or not cp.vl["SEATBELT_STATUS"]['SEATBELT_DRIVER_LATCHED'])

        steer_status = self.steer_status_values[cp.vl["STEER_STATUS"]['STEER_STATUS']]
        ret.steerError = steer_status not in ['NORMAL', 'NO_TORQUE_ALERT_1', 'NO_TORQUE_ALERT_2', 'LOW_SPEED_LOCKOUT',
                                              'TMP_FAULT']
        ...
        if self.CP.carFingerprint in (
        CAR.CRV, CAR.CRV_EU, CAR.HRV, CAR.ODYSSEY, CAR.ACURA_RDX, CAR.RIDGELINE, CAR.PILOT_2019, CAR.ODYSSEY_CHN):
        ...
        if self.CP.carFingerprint in HONDA_BOSCH:
            ...
            if self.CP.carFingerprint in (
            CAR.CIVIC_BOSCH, CAR.CIVIC_BOSCH_DIESEL, CAR.ACCORDH, CAR.CRV_HYBRID, CAR.INSIGHT):
            ...
            ret.cruiseState.speed = self.v_cruise_pcm_prev if cp.vl["ACC_HUD"]['CRUISE_SPEED'] > 160.0 else \
            cp.vl["ACC_HUD"]['CRUISE_SPEED'] * CV.KPH_TO_MS
        ...
        if self.CP.carFingerprint in HONDA_BOSCH:
            ...
            ret.stockAeb = bool(
                cp_cam.vl["BRAKE_COMMAND"]["AEB_REQ_1"] and cp_cam.vl["BRAKE_COMMAND"]["COMPUTER_BRAKE"] > 1e-5)
