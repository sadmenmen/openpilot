...
def thermald_thread():
    ...
    while 1:
        ...
        if pandaState is not None:
            ...
            startup_conditions["hardware_supported"] = pandaState.pandaState.pandaType is not None
            ...
            if handle_fan is None and pandaState.pandaState.pandaType != log.PandaState.PandaType.unknown:
                ...
                has_relay = pandaState.pandaState.pandaType in [log.PandaState.PandaType.blackPanda,
                                                                log.PandaState.PandaType.uno,
                                                                log.PandaState.PandaType.dos]
        ...
        is_offroad_for_5_min = (started_ts is None) and (
                    (not started_seen) or (off_ts is None) or (sec_since_boot() - off_ts > 60 * 5))
        ...
        startup_conditions["up_to_date"] = params.get("Offroad_ConnectivityNeeded") is None or params.get(
            "DisableUpdates") == b"1"
        ...
        if (count % int(600. / DT_TRML)) == 0:
            ...
            cloudlog.event("STATUS_PACKET",
                           ...
                           location=(
                               strip_deprecated_keys(location.gpsLocationExternal.to_dict()) if location else None),
